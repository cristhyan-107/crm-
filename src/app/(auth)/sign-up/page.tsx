  ...
  if (success) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background">
        ...
        <Card className="w-full max-w-md relative z-10 border-white/10 bg-background/50 backdrop-blur-xl shadow-2xl text-center">
          <CardHeader>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <Link href="/" className="flex items-center gap-2 mb-8 relative z-10">
        ...
        <span className="font-bold text-2xl tracking-tight text-white">CloseCRM</span>
      </Link>

      <Card className="w-full max-w-md relative z-10 border-white/10 bg-background/50 backdrop-blur-xl shadow-2xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl text-center">Crie sua conta</CardTitle>
          <CardDescription className="text-center">
            Junte-se a corretores de alta performance
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-2">
            <Button variant="outline" onClick={handleGoogleSignIn} className="border-white/10 hover:bg-white/5">
