        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12">
              Organize seus atendimentos, automatize seus follow-ups e feche
              mais negócios. O CRM perfeito para corretores e vendedores de alto
              ticket.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-14 px-8 text-base border-white/10 hover:bg-white/5 bg-transparent"
              >
                Ver como funciona
              </Button>
            </div>
                    ...
                    {[
                      ...
                      <div key={i} className="flex flex-col gap-3">
                        <div className="flex items-center gap-2 mb-2">
                          <span
                            className={`px-2 py-1 text-xs rounded-md ${col.color} font-medium`}
                          >
                            {col.title}
                          </span>
                        ...
                        {[...Array(col.count)].map((_, j) => (
                          <div
                            key={j}
                            className="h-24 bg-white/5 border border-white/5 rounded-lg p-4 flex flex-col justify-between"
                          >
          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Projetado especificamente para quem atende via WhatsApp, fecha
                projetos de alto valor e não tem tempo para sistemas complexos.
              </p>
            </div>

            <div id="beneficios" className="grid md:grid-cols-3 gap-8">
              <Card className="bg-white/5 border-white/10 p-8 hover:bg-white/10 transition-colors">
                ...
                <p className="text-muted-foreground">
                  Arraste e solte seus leads. Saiba exatamente em qual etapa
                  cada negociação está, sem planilhas confusas.
                </p>
              </Card>
              ...
              <Card className="bg-white/5 border-white/10 p-8 hover:bg-white/10 transition-colors">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">
                  Histórico e Follow-ups
                </h3>
                <p className="text-muted-foreground">
                  Registre cada interação. O sistema te avisa quando um lead
                  esfriar ou quando for hora de retornar o contato.
                </p>
              </Card>
              ...
              <Card className="bg-white/5 border-white/10 p-8 hover:bg-white/10 transition-colors">
                ...
                <p className="text-muted-foreground">
                  Acompanhe sua taxa de conversão, leads por origem e projeção de
                  receita em tempo real de forma linda e clara.
                </p>
              </Card>
            </div>
          </div>
        ...
        <section className="py-24 md:py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Junte-se a corretores e vendedores que organizaram o caos e
              multiplicaram seus fechamentos.
            </p>

            <Button
              render={<Link href="/sign-up" />}
              className="h-16 px-10 text-lg bg-white text-black hover:bg-white/90 font-semibold rounded-full shadow-[0_0_40px_rgba(255,255,255,0.3)]"
            >
      ...
      <footer className="border-t border-white/10 py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            © 2026 CloseCRM. Desenvolvido para vendedores modernos.
          </p>
        </div>
      </footer>
    </div>
